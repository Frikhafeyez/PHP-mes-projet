...
include "inscrit.class.participants.php";
...
//creation de l'objet
$insc =new participant($id, $nom, $prenom, $email, $photo, $tel, $pays);

switch($action){
	case "add1":include "inscription.php";
	break;
